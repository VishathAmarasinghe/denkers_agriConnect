  ...
  return (
    <SafeAreaView className="flex-1 bg-blue-50">
      <ScrollView className="flex-1 p-4">
        {/* Header */}
        <View className="bg-orange-600 p-4 rounded-lg mb-6">
          <View className="flex-row items-center justify-between">
            <View>
              <Text className="text-2xl font-bold text-white">Machine Rent</Text>
              <Text className="text-orange-200 mt-1">Rent farming equipment</Text>
            </View>
              ...
              <Card.Content className="p-4">
                <View className="flex-row items-start mb-3">
                  ...
                  <View className="flex-1">
                    <Title className="text-lg text-gray-800 mb-1">{machine.name}</Title>
                    <Text className="text-sm text-gray-600 mb-2">{machine.type}</Text>
                    <Text className="text-xs text-gray-500 mb-2">{machine.description}</Text>
                    
                    <View className="flex-row items-center mb-2">
                      <MaterialIcons name="location-on" size={16} color="#666" />
                      <Text className="text-xs text-gray-600 ml-1">{machine.location}</Text>
                    </View>
                  </View>
                  ...
                  <Chip 
                    ...
                    icon={() => (
                      <MaterialIcons 
                        ...
                        size={16} 
                        color={machine.status === 'available' ? '#4CAF50' : machine.status === 'rented' ? '#2196F3' : '#F44336'} 
                      />
                    )}
                  >
                ...
                <View className="bg-gray-50 p-3 rounded-lg mb-3">
                  <Text className="text-sm font-medium text-gray-800 mb-2">Rental Rates</Text>
        ...
        <Card className="mb-6 shadow-md">
          <Card.Content>
            <Title className="text-lg text-orange-800 mb-4">Rental Tips</Title>
            ...
            <View className="space-y-3">
              <View className="flex-row items-start">
                ...
                <View className="ml-3 flex-1">
                  ...
                  <Text className="text-xs text-gray-600">Popular equipment gets booked quickly during peak seasons</Text>
                </View>
              </View>
              ...
              <View className="flex-row items-start">
                ...
                <View className="ml-3 flex-1">
                  ...
                  <Text className="text-xs text-gray-600">Always inspect equipment before use and report any issues</Text>
                </View>
              </View>
